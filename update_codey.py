...
def update_brutal_stats(codey, daily_activity, all_time_data, user_data):
    ...
    # NEU:
    codey['health'] = (codey['energy'] * 0.35 + codey['happiness'] * 0.35 + codey['hunger'] * 0.30)
    # Streak bonus
    if codey['streak'] >= 30: codey['health'] = min(100, codey['health'] + 10)
    elif codey['streak'] >= 7: codey['health'] = min(100, codey['health'] + 5)
